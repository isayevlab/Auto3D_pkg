...
def cli() -> None:
    ...
    if len(sys.argv) == 2 and _is_yaml_file(sys.argv[1]):
        ...
        # Auto3D.presentation.cli.app._ReservedStdoutCommand: this is a whole command body,
        ...
        from Auto3D.presentation.cli.console import reserve_stdout
...
def _run_legacy_yaml(yaml_path: str) -> None:
    ...
    from Auto3D.presentation.cli.console import console, print_banner, print_warning
    from Auto3D.presentation.cli.errors import handle_error, handle_interrupt, job_directory_hint
    ...
    try:
        ...
        from Auto3D.presentation.cli.config_schema import load_yaml_config, require_input_path
        from Auto3D.presentation.cli.results import (
            FailedMolecule,
            RunSummary,
            print_failures,
