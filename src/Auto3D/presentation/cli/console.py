...
# `Auto3D.presentation.cli.app._ReservedStdoutCommand` (every Typer command, however the
# app is driven -- console script, `python -m`, an embedding caller, click's
# CliRunner) and `Auto3D.presentation.auto3Dcli._run_legacy_yaml` (the deprecated
...
# themselves -- see `Auto3D.orchestration.workflow_workers._worker_stdout_to_stderr`.
# ---------------------------------------------------------------------------
