...
from Auto3D.presentation.cli.console import console, reserve_stdout
...
class _ReservedStdoutCommand(TyperCommand):
    ...
    anything (see ``Auto3D.presentation.cli.console`` for the defect this closes), and the
...
#
# `run` (-> Auto3D.entry.auto3D.main) drives these pipeline stages through
...
def run(
    ...
    from Auto3D.presentation.cli.commands.run import execute_run
...
def config_init(
    ...
    from Auto3D.presentation.cli.commands.config import execute_config_init
...
def config_show(
    ...
    from Auto3D.presentation.cli.commands.config import execute_config_show
...
def config_validate(
    ...
    from Auto3D.presentation.cli.commands.config import execute_config_validate
...
def models_list() -> None:
    ...
    from Auto3D.presentation.cli.commands.models import execute_models_list
...
def models_info(
    ...
    from Auto3D.presentation.cli.commands.models import execute_models_info
...
def models_test(
    ...
    from Auto3D.presentation.cli.commands.models import execute_models_test
...
def validate(
    ...
    from Auto3D.presentation.cli.commands.validate import execute_validate
...
def energy(
    ...
    from Auto3D.presentation.cli.commands.properties import execute_energy
...
def optimize(
    ...
    from Auto3D.presentation.cli.commands.properties import execute_optimize
...
def thermo(
    ...
    from Auto3D.presentation.cli.commands.properties import execute_thermo
...
def tautomers(
    ...
    from Auto3D.presentation.cli.commands.properties import execute_tautomers
