...
# them from Auto3D.entry.auto3D.
from Auto3D.orchestration.workflow_workers import (  # noqa: F401
    isomer_wrapper,
    logger_process,
    optim_rank_wrapper,
)
...
def main(
    ...
    Returns:
        A :class:`Auto3D.foundation.results.WorkflowResult` -- a ``str`` subclass holding
