...
class Calculator(ase.calculators.calculator.Calculator):
    ...
    The first argument is a :class:`Auto3D.engines.models.contract.ModelAdapter` and it
    is the ONLY model-dependent input: it supplies the energy/force call *and*
    the species convention (:meth:`~Auto3D.engines.models.contract.ModelAdapter.to_species`).
    ...
    def __init__(self, adapter: ModelAdapter, charge=0, *, device=None, dtype=None):
        ...
        Args:
            adapter: The model, satisfying
                :class:`Auto3D.engines.models.contract.ModelAdapter`. Checked here, for
        ...
        if missing:
            raise TypeError(
                ...
                f"Build one with Auto3D.engines.model_factory.create_model."
            )
