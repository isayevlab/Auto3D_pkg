...
def load_custom_nnp(
    ...
    *,
    ...
    # module's `training` flag, so an archive saved before its author called
    # .eval() keeps dropout and batchnorm live at inference. That makes the
    # energy differ between identical calls, which FIRE cannot converge
