...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        parser.add_argument('--tauto_k', type=int, default=None,
                            help='Outputs the top-k tautomers for each SMILES.')
        parser.add_argument('--tauto_window', type=float, default=None,
                            help=('Outputs the tautomers whose energies are within '
                                'window (kcal/mol) from the lowest energy'))
